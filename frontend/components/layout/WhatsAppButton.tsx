    ...
    <div className="fixed bottom-8 right-8 z-[2000] flex items-center justify-end">
      ...
      <div className="relative" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
        ...
        <a
          ...
          className="relative flex items-center justify-center w-11 h-11 md:w-14 md:h-14 rounded-full bg-[#25D366] shadow-[0_6px_24px_rgba(37,211,102,0.45)] cursor-pointer hover:scale-110 transition-transform active:scale-95"
        >
          <svg viewBox="0 0 32 32" className="w-6 h-6 md:w-[30px] md:h-[30px]" fill="white">
